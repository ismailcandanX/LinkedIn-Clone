...
function PostModal(props) {
    ...
    const handleChange = (e) => {
        ...
        if (image === "" || image === undefined) {
            alert(`It is not an image, the file is ${typeof image}`)
            return
        }
        setShareImage(image)
    }
                        ...
                        <SharedCreation>
                            <AttachAssets>
                                <AssetButton onClick={() => switchAssetArea("image")}>
                                    <img src="/images/photo-icon.svg" alt="share" />
                                </AssetButton>
                                <AssetButton onClick={() => switchAssetArea("media")}>
                                    <img src="/images/video-icon.svg" alt="share" />
                                </AssetButton>
                                <AssetButton>
                                    <img src="/images/job-icon.svg" alt="share" />
                                </AssetButton>
                                <AssetButton>
                                    <img src="/images/write-article-icon.svg" alt="share" />
                                </AssetButton>
                            </AttachAssets>
                            <ShareComment>
                                <AssetButton>
...
const PostButton = styled.button`
    ...
    padding-left: 16px;
    padding-right: 16px;
    background: ${props => props.disabled ? '#e0e0e0' : '#0a66c2'};
    color: #fff;
    border: none;
    transition: all 0.15s ease-in-out;
    &:hover {
        background: ${props => props.disabled ? '#e0e0e0' : '#004182'};
    }
`
